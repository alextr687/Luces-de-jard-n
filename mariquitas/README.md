...
* En primer lugar, el uso de grapas está limitado a zonas concretas del árbol, para evitar en lo posible provocar heridas innecesarias.
* En segundo lugar, las grapas utilizadas son de cobre, no de acero. El cobre es un metal naturalmente antimicrobiano, al igual que sus óxidos. La herida que se forma con esta grapa queda desinfectada de forma natural.
* Por último, el roble (*Quercus robur*) es una especie extraordinariamente resistente a lesiones. Además, la corteza (que es tejido muerto) tiene un grosor que ronda los 3 cm en el tronco, y 1 cm en las ramas. Las grapas utilizadas son de 11,4 x 10 mm, de forma que ni siquiera llegan a tejido sano.

Los soportes del controlador y el sensor PIR están fijados al árbol mediante sendos tornillos de acero inoxidable. Es una decisión motivada por la dificultar de encontrar un sistema de fijación menos intrusivo pero, a la vez, igualmente efectivo. La fijación de los soportes debe soportar un momento flexor considerable, pues ambos elementos sobresalen mucho más que, por ejemplo, las mariquitas. También son significativamente más pesados y propensos a soportar el viento. La técnica del doble nudo corredizo no es apta en este caso por no proporcionar la tensión suficiente para el momento flexor soportado (la ausencia de estrangulamiento es precisamente el motivo por el que se escoge este sistema en la mayoría de las fijaciones de este proyecto). Otros sistemas 

Pese a que los cables sean muy visibles inmediatamente tras la instalación, en Galicia, y tratándose de un roble, se espera que, a lo sumo, en el plazo de dos años, la mayoría de los elementos queden completamente cubiertos de una capa de musgo y líquen. Además, es un sistema de fijación natural mejor incluso que las grapas. En cualquier caso, los conductores deberán situarse siempre en las partes menos visibles del árbol, como por encima de las ramas o por detrás del tronco (suponiendo que el observador está en una posición conocida). Otras posibles soluciones, como bridas o bandas elásticas quedaron descartadas, bien por el problema del estrangulamiento del árbol, bien por ser demasiado llamativas, respectivamente. Así, del mal, el menos, es el tornillo.
